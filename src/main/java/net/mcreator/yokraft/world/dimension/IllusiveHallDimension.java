...
public class IllusiveHallDimension extends YokraftElements.ModElement {
	@ObjectHolder("yokraft:illusivehall")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public IllusiveHallDimension(YokraftElements instance) {
		super(instance, 3);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("illusivehall"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("yokraft:illusivehall")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("yokraft:illusivehall"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("yokraft:illusivehall"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("end_barrens")),};
	}
