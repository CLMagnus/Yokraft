...
import net.mcreator.yokraft.procedures.GokanssugarFoodEatenProcedure;
...
public class GokanssugarItem extends YokraftElements.ModElement {
	@ObjectHolder("yokraft:gokanssugar")
	public static final Item block = null;
	public GokanssugarItem(YokraftElements instance) {
		super(instance, 47);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemStack, World world, LivingEntity entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				GokanssugarFoodEatenProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
