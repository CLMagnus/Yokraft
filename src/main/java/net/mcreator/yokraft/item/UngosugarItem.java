...
import net.mcreator.yokraft.procedures.UngosugarFoodEatenProcedure;
...
public class UngosugarItem extends YokraftElements.ModElement {
	@ObjectHolder("yokraft:ungosugar")
	public static final Item block = null;
	public UngosugarItem(YokraftElements instance) {
		super(instance, 46);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemStack, World world, LivingEntity entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				UngosugarFoodEatenProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
