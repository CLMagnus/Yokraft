...
import net.mcreator.yokraft.procedures.BuddahsSugarFoodEatenProcedure;
...
public class BuddahsSugarItem extends YokraftElements.ModElement {
	@ObjectHolder("yokraft:buddahssugar")
	public static final Item block = null;
	public BuddahsSugarItem(YokraftElements instance) {
		super(instance, 50);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemStack, World world, LivingEntity entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				BuddahsSugarFoodEatenProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
