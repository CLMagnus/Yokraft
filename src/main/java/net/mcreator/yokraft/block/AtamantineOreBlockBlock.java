...
public class AtamantineOreBlockBlock extends YokraftElements.ModElement {
	@ObjectHolder("yokraft:atamantineoreblock")
	public static final Block block = null;
	public AtamantineOreBlockBlock(YokraftElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("atamantineoreblock");
		}
