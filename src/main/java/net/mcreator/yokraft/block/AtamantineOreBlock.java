...
import net.mcreator.yokraft.item.AtamantineIngotItem;
...
public class AtamantineOreBlock extends YokraftElements.ModElement {
	@ObjectHolder("yokraft:atamantineore")
	public static final Block block = null;
	public AtamantineOreBlock(YokraftElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AtamantineIngotItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("atamantineore", "atamantineore", blockAt -> {
